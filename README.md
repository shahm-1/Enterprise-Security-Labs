...
## ☁️ Microsoft 30-Day Cloud SOC Challenge

**[→ View Full Project](./Microsoft-30-Day-Challenge/)**
...
**Skills Demonstrated:** KQL query writing • Incident response • Threat hunting • Log correlation • MITRE ATT&CK mapping • Cloud security

**Stack:** Microsoft Sentinel • Defender XDR • Entra ID • Intune • Azure Monitor • KQL

---

## 📊 Splunk 101 - SOC Investigation
...
| **Query Languages** | KQL (Kusto) • SPL (Splunk) |
| **Endpoint Security** | Microsoft Defender for Endpoint • Sysmon |
| **Identity & Access** | Active Directory • Azure Entra ID • Intune • MFA |
| **Cloud Platforms** | Microsoft Azure • Microsoft 365 • Hybrid environments |
| **Infrastructure** | Windows Server 2019/2022 • PowerShell • VMware |
| **Logging & Monitoring** | Azure Monitor • Splunk Forwarders • Windows Event Logs • Audit Policy |

---

## 📊 What These Labs Support
...
> *All labs maintained for continuous learning and portfolio development. Environments rebuilt regularly to practice infrastructure deployment and security configurations. These labs are my proving ground — everything I know about enterprise security started here.*
